				...
				<div class="about span_1_of_2">
					...
					<div class="about-top">
						...
						<div class="desc span_3_of_2">
							...
							<a href="<?php echo $movie['video_url']; ?>" target="_blank" style="background-color:black;" class="watch_but">Watch Trailer</a>
						</div>
						<div class="clear"></div>
					</div>
					<table class="table table-hover table-bordered text-center">
						...
						<tr>
							<td colspan="2"><?php if ($avl[0] == $screen['seats']) { ?><button type="button" class="btn btn-danger" style="width:100%">House Full</button><?php } else { ?>
									<button style="background-color:red;width:100%;" class="btn btn-info"">Book Now</button><br>
									<br>
								<?php } ?>
								...
								<form action="billsplit.php" method="post">
									<button style="background-color:red;width:100%;" class="btn btn-info" style="width:100%">Bill Split</button>
								</form>
							-->
							</td>
						</tr>
